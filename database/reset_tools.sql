-- ============================================
-- LIMPAR E RESETAR FERRAMENTAS
-- ============================================

-- 1. DELETAR TUDO (com certeza)
DELETE FROM tool_costs WHERE 1=1;

-- 2. RESETAR SEQUÊNCIA (se usar SERIAL)
-- ALTER SEQUENCE tool_costs_id_seq RESTART WITH 1;

-- 3. INSERIR AS 15 FERRAMENTAS LIMPAS
